...
fun main() = Task({
    ...
    file("AdventOfCode2022/in/day7/part2.in")
}) {
    var current = ""
    ...
    val missingSpace = 30000000 - 70000000 + root.size
    writeValue(root.recursiveSubdirectories.filter { it.size >= missingSpace }.minBy { it.size }.size)
}